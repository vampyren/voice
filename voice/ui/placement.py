...
#: the only record of why was a log line in the daemon's journal. Short enough
#: to stay on one line under the placer, where it is one of three notes and the
#: window is a form, not a manual.
NO_LAYER_SHELL_NOTE = ("This desktop places the pill itself - only KDE/wlroots "
                       "honours it.")
