...
Two things behave differently between desktops, and both decide whether your words
actually land in the window you are looking at.
...
it before sending the paste shortcut — see [Recording pill](#recording-pill).
...
- **Copied** — the text is on the clipboard and voice could *not* confirm the paste
  ...
  [Desktop setup](#2-whether-voice-can-tell-which-window-you-are-in).
